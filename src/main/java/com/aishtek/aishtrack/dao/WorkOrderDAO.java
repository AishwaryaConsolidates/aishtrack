...
public class WorkOrderDAO extends BaseDAO {
  ...
  public static ArrayList<WorkOrder> searchFor(Connection connection, String customerName,
    ...
    String sql =
        "SELECT wo.id, wo.customer_id, wo.type, wo.status, wo.status_date, wo.notes, wo.deleted, c.name from work_orders wo, customers c where wo.customer_id = c.id and wo.deleted = 0 ";
